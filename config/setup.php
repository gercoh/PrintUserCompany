...
try {
	...
	//DB creation
	// $sql = "DROP DATABASE IF EXISTS printuser";
	// $db->exec($sql);
	$sql = "CREATE DATABASE IF NOT EXISTS printuser";
	$db->exec($sql);
	...
	$sql = "USE printuser;
		...
		CREATE TABLE `obj_services`
			...
			INSERT INTO `obj_customers` (`id_customer`, `name_customer`, `company`) VALUES (NULL, 'Nugno Menat', 'company_1'), (NULL, 'Zadanie Eto', 'company_2') , (NULL, 'Nashel Na', 'company_1'), (NULL, 'Git HUBE', 'company_3'), (NULL, 'Izmenil Tolko', 'company_3'), (NULL, 'Host podkluchenie', 'company_1');
